      ...
      {pricing.map((item) => (
        ...
        >
          ...
          <div className="flex items-center h-[5.5rem] mb-6">
            {item.price && (
              // need this react fragment to have two divs right after each other
              <>
          ...
          <Button
            href={item.price ? "/pricing" : "mailto:mariamf.khan@outlook.com"}
            className="w-full mb-6"
            white={!!item.price}  // if price exists, then button will be white (true)
          >
